...
public class BankAccount {
		...
		void display() {
			...
			"\nUser full name: " + firstName + " " + middleName + " " + lastName +
	...
	public static void main (String [] args) {
		...
		bankAccount bank = bankAccount.new bankAccount();

	
		String fName =  bank.getFirstName();
		String mName = bank.getMiddleName();
		String lName = bank.getLastName();
		doZAuble balence = bank.getBalance();
		String password = bank.getPassword();


		System.out.println("Hello " + fName + " " + mName + " " + lName + " your current bank account balence is " + balence);
		...
		double amount = 0;
		double otherAcct = 54321;
		String pswd = password ;
		boolean check = bank.transferFrom(amount, otherAcct, pswd);
		String mess = bank.getMessage();
